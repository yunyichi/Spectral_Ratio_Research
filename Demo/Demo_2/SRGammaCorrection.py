...
# Main processing
image_path = 'chathankandy_anjithprakash_032.tif'  # Replace with your image path
...
if image is None:
    ...
    # Predefined points
    # lit_point = np.array([255.0, 244.0, 246.0])  # Example lit point (BGR format)
    # dark_point = np.array([65.0, 56.0, 44.0])  # Example dark point (BGR format)

    lit_point = np.array([245.0, 214.0, 230.0])  # Example lit point (BGR format)
    dark_point = np.array([53.0, 38.0, 27.0])  # Example dark point (BGR format)
